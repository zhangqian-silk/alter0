...
当前优先级以 [`features.md`](./features.md) 为准，发布节奏按 release-gate 管控（回归矩阵、风险基准、通道 chaos drill、配置参数治理、回滚演练、部署检查、文档同步）；当前主线已完成 P5/N28（通道 chaos drill 门禁），下一项关注为“基于真实故障样本回填通道阈值并持续压降误报率”。
