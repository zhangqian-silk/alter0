...
- 启动阶段 file-backed Skill 文件校验，确保 `.alter0/skills/deploy-test-service/SKILL.md`、`docs/skills/frontend-design/SKILL.md` 与 `.alter0/skills/artifact-preview/SKILL.md` 可被当前仓库解析。
