...
- `internal/interfaces/web/frontend/index.html`、`static/dist/index.html` 与登录页模板统一以 `html[lang="en"]` 启动；`LegacyWebShell` 与 `ReactRuntimeFacade` 通过监听和回写 `document.documentElement.lang` 统一驱动中英文壳层文案切换。
