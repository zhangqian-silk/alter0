...
func buildTravelWorkspaceOperatorPrompt(
	...
	builder.WriteString("- Read the current travel agent's private file-backed `SKILL.md` before changing reusable page rules.\n")
	builder.WriteString("- Update the private travel-agent skill only for durable reusable preferences that should affect future city pages. Do not store one-off itinerary details in the skill.\n")
