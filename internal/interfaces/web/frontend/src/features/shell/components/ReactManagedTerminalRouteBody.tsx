    ...
    timeline: {
      ...
      overlay: (
        <ScrollJumpStrip
          ...
          watchKey={`${activeSessionID}:${turns.length}:${Object.keys(expandedTurns).length}:${Object.keys(expandedSteps).length}:${Object.keys(stepDetails).length}:${metaOpen ? "meta" : "plain"}:${submitting ? "submitting" : "idle"}`}
