...
run "config preflight validation gate" "$ROOT_DIR/scripts/check-config-validate-preflight.sh"
...
run "github dependency gate" "$ROOT_DIR/scripts/check-github-dependency.sh"
