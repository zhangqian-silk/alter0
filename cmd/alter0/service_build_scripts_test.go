...
func TestServiceBuildScriptsUseUnifiedFrontendAwareBuild(t *testing.T) {
	...
	assertContains(t, startScript, "CODEX_COMMAND_MODE=\"${ALTER0_CODEX_COMMAND_MODE:-auto}\"")
	assertContains(t, startScript, "ALTER0_CODEX_COMMAND_MODE='${CODEX_COMMAND_MODE}'")
	assertNotContains(t, startScript, "CODEX_COMMAND=\"/usr/local/bin/codex\"")
